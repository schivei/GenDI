...
<!-- benchmark-ci:start -->
_Updated by [CI run #231](https://github.com/schivei/GenDI/actions/runs/33533719964) on 2026-09-01 16:49 UTC_

| Method | Mean | Allocated |
|---|---:|---:|
| Manual registration (no GenDI) | 3.206 μs | 7.42 KB |
| GenDI: constructor injection (generated) | 13.325 μs | 9.98 KB |
| GenDI: property injection (generated) | 13.287 μs | 9.98 KB |
| GenDI: with decorator, property injection (generated) | 19.594 μs | 14.26 KB |
| Reflection registration (no GenDI, assembly scan) | 77.926 μs | 23.9 KB |

### CI analysis

- GenDI constructor injection is **+315.6%** versus manual registration.
- GenDI property injection is **+314.4%** versus manual registration.
- Reflection scanning remains the outlier at **~24.3x slower** and **~3.2x higher allocation** than manual registration.
