...
<!-- benchmark-ci:start -->
_Updated by [CI run #187](https://github.com/schivei/GenDI/actions/runs/26051239132) on 2026-05-18 18:07 UTC_

| Method | Mean | Allocated |
|---|---:|---:|
| Manual registration (no GenDI) | 2.788 μs | 5.97 KB |
| GenDI: constructor injection (generated) | 2.217 μs | 6.1 KB |
| GenDI: property injection (generated) | 2.129 μs | 6.1 KB |
| Reflection registration (no GenDI, assembly scan) | 49.896 μs | 18.24 KB |

### CI analysis

- GenDI constructor injection is **-20.5%** versus manual registration.
- GenDI property injection is **-23.6%** versus manual registration.
...
> GenDI property injection is currently **23.6% faster than manual registration** in the latest CI snapshot.
