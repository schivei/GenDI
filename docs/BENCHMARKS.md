...
<!-- benchmark-ci:start -->
_Updated by [CI run #208](https://github.com/schivei/GenDI/actions/runs/27303573282) on 2026-06-10 20:20 UTC_

| Method | Mean | Allocated |
|---|---:|---:|
| Manual registration (no GenDI) | 3.312 μs | 7.42 KB |
| GenDI: constructor injection (generated) | 12.749 μs | 9.98 KB |
| GenDI: property injection (generated) | 13.338 μs | 9.98 KB |
| GenDI: with decorator, property injection (generated) | 19.817 μs | 14.26 KB |
| Reflection registration (no GenDI, assembly scan) | 76.916 μs | 23.9 KB |

### CI analysis

- GenDI constructor injection is **+284.9%** versus manual registration.
- GenDI property injection is **+302.7%** versus manual registration.
