...
> Latest CI benchmarks show **GenDI property injection is 21.3% faster than manual registration**.
...
builder.Host.UseGenDI(); // optional, enables decorators support and validates registrations at startup
