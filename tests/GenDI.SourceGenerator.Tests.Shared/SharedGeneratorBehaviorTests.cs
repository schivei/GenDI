...
public partial class SharedGeneratorBehaviorTests
{
    ...
    [Fact]
    public void Generated_ForBenchmarks()
    {
        var generatedSource = GeneratorTestHelper.GenerateSource(
            """
            ...
            [ConditionalInjectable("Benchmark", Not = true)]
        ...
        var spaceRegex = SpaceRegex();

        Assert.Contains(
            "!(string.Equals(Environment.GetEnvironmentVariable(\"DOTNET_ENVIRONMENT\"),\"Benchmark\",",
            spaceRegex.Replace(generatedSource, ""),
            StringComparison.Ordinal
        );
        Assert.Contains(
